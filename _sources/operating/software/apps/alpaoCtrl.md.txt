...
`alpaoCtrl` [does stuff in detail]

## Options

alpaoCtrl accepts the [standard options](index.html#standard-options)
...
To start the [description of app or alpaoCtrl] for [context]:
```
/opt/MagAOX/bin/alpaoCtrl -n [contextname]
```

## See also

[Source code.](../../../MagAOX/group__alpaoCtrl.html)
